...
if(char === "RR"){
  ...
  e1Charge.velocityY = Math.round(random(10,45))
  e2Charge.velocityY = Math.round(random(10,45))
  e3Charge.velocityY = Math.round(random(10,45))
  e4Charge.velocityY = Math.round(random(10,45))
  e5Charge.velocityY = Math.round(random(10,45))
  e6Charge.velocityY = Math.round(random(10,45))
  e7Charge.velocityY = Math.round(random(10,45))
